...
public class MultiLongLongMap {
	...
	public MultiLongLongMap(int hashLength, int storage, int keySize, boolean expandable) {
	...
	public void put(long[] key, long value){
		...
		if (full) {
			...
			long[] newArray = new long[(keySize + 2) * storage + 1];
